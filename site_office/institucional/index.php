    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
				...
				<h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1" style="color: rgb(122, 228, 122);"> <span class="typed-words"></span></h1>
...
<section class="features18 popup-btn-cards cid-rGf2OJvfMF" id="servicos">
    <div class="container">
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                                O profissional de Sistemas de Informação (ou SI), administra fluxos de Informação em qualquer rede 
                                de computadores, seja de empresas ou particulares. Ele desenvolve sistemas de armazenamento e 
...
<section class="mbr-section form1 cid-rIntaGpt7F" id="contato">
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">
                    Nos envie um email para receber informações adicionais e sanar qualquer dúvida!</h3>
            </div>
        </div>
    </div>
    <div class="container">
